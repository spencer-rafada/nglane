...
export const products: Product[] = [
  ...
  { id: "6", name: "Crepe Set", description: "A stylish crepe fabric set for formal occasions.", price: 89.99, category: "sets", image: "/assets/crepe_set.png" },
  { id: "7", name: "Vintage Set", description: "Classic vintage outfit with a modern touch.", price: 99.99, category: "sets", image: "/assets/vintage_set.png" },
  { id: "8", name: "Linen Pants", description: "Breathable and stylish linen pants.", price: 49.99, category: "pant", image:"/assets/linen_pants1.png" },
